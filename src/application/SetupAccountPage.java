    ...
    public void show(Stage primaryStage) {
        ...
        setupButton.setOnAction(a -> {
            ...
            if (!usernameValidationMessage.isEmpty()) {
                // Display the error message from UserNameRecognizer
                errorLabel.setText(usernameValidationMessage);
                return; 
            }
            ...
            if (!passwordValidationMessage.isEmpty()) {
                // Display the error message from evaluatePassword
                errorLabel.setText(passwordValidationMessage);
                return; 
            }
