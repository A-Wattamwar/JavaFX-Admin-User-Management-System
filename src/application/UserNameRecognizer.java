...
public class UserNameRecognizer {
	 ...
	 * 
	 * <p> Copyright: Ayush Sachin Wattamwar © 2024 </p>
	 * 
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						(currentChar >= 'a' && currentChar <= 'z' )) { 	// Check for a-z , I changed the code so that 0-9 can't be accepted
					nextState = 1;
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a '.', '-', or '_' must be A-Z, a-z, 0-9.\n"; // Edited this according to the code
			return userNameRecognizerErrorMessage;
